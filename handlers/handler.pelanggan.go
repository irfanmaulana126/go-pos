...
import (
	...
	"github.com/irfanmaulana126/go-pos/helpers"
	"github.com/irfanmaulana126/go-pos/pkg"
...
func NewHandlerCustomer(customer entitys.EntityCustomer) *handleCustomer {
...
func ValidatorCustomer(ctx *gin.Context, input schemas.SchemaCustomer, Type string) (interface{}, int) {
