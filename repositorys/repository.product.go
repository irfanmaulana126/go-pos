...
func (r *repositoryProduct) EntityProductByMerchant(input *schemas.SchemaProduct) (*[]models.ModelProduct, schemas.SchemaDatabaseError) {
	var product []models.ModelProduct
...
func (r *repositoryProduct) EntityProductByOutlet(input *schemas.SchemaProduct) (*[]models.ModelProduct, schemas.SchemaDatabaseError) {
	var product []models.ModelProduct
